  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col gap-3">
        {submissions.map((sub) => (
          <div key={sub.id} className="border border-gray-100 p-3 rounded-lg hover:border-gray-300 transition-colors flex items-start gap-3 cursor-pointer">
            ...
            <span className="text-xs text-gray-400 whitespace-nowrap">{sub.submittedAt}</span>
          </div>
        ))}
